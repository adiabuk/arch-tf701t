...
_pkg_config = {
    ...
    'qt_framework':       0,
    'sip_bin':            '/usr/bin/sip',
    'sip_config_args':    'CFLAGS=-march=armv7-a -mfloat-abi=hard -mfpu=vfpv3-d16 -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 LFLAGS=-Wl,-O1,--sort-common,--as-needed,-z,relro',

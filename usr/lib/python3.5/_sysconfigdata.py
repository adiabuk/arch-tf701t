...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
           ...
           '-Wstrict-prototypes -march=armv7-a -mfloat-abi=hard '
           '-mfpu=vfpv3-d16 -O2 -pipe -fstack-protector '
           '--param=ssp-buffer-size=4 -march=armv7-a -mfloat-abi=hard '
           '-mfpu=vfpv3-d16 -O2 -pipe -fstack-protector '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-march=armv7-a -mfloat-abi=hard -mfpu=vfpv3-d16 -O2 '
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-shared' '--with-threads' "
                ...
                "'--with-system-ffi' 'CFLAGS=-march=armv7-a -mfloat-abi=hard "
                '-mfpu=vfpv3-d16 -O2 -pipe -fstack-protector '
                "--param=ssp-buffer-size=4' "
 ...
 'COVERAGE_INFO': '/tmp/yaourt-tmp-amro/aur-python35/src/Python-3.5.0b2/coverage.info',
 'COVERAGE_REPORT': '/tmp/yaourt-tmp-amro/aur-python35/src/Python-3.5.0b2/lcov-report',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-Wall -Wstrict-prototypes -march=armv7-a -mfloat-abi=hard '
                   '-mfpu=vfpv3-d16 -O2 -pipe -fstack-protector '
                   '--param=ssp-buffer-size=4 -march=armv7-a -mfloat-abi=hard '
                   '-mfpu=vfpv3-d16 -O2 -pipe -fstack-protector '
                   '--param=ssp-buffer-size=4 '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/yaourt-tmp-amro/aur-python35/src/Python-3.5.0b2',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/yaourt-tmp-amro/aur-python35/src/Python-3.5.0b2 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/yaourt-tmp-amro/aur-python35/src/Python-3.5.0b2 '
 ...
 'abs_builddir': '/tmp/yaourt-tmp-amro/aur-python35/src/Python-3.5.0b2',
 'abs_srcdir': '/tmp/yaourt-tmp-amro/aur-python35/src/Python-3.5.0b2',
